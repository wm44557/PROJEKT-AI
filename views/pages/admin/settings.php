...
<form action="<?php echo STARTING_URL ?>/admin/settings" class="boxEdit" method="post">
    ...
    <input class="form-input" type="text" name="id" value="<?php echo  $params[0]->id ?>" readonly disabled><br><br>

    <label for="login">LOGIN: </label>
    <input class="form-input" type="text" name="login" value="<?php echo  $params[0]->login ?>" readonly disabled><br><br>
    ...
    <input class="form-input" list="browsers" name="permission" id="permission" value="<?php echo  $params[0]->role ?>" readonly disabled>
